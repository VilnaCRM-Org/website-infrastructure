...
resource "aws_cloudwatch_metric_alarm" "s3_objects_anomaly_detection" {
  count               = var.enable_cloudwatch_alarms && var.enable_anomaly_detection_alarms && !var.staging ? 1 : 0
...
resource "aws_cloudwatch_metric_alarm" "s3_4xx_errors_anomaly_detection" {
  count               = var.enable_cloudwatch_alarms && var.enable_anomaly_detection_alarms ? 1 : 0
